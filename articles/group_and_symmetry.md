...
于是群$G$就同构于$\Z/n\Z \simeq \Z/n_{11}\Z\times\Z/n_{22}\Z\times\cdots\times\Z/n_{kk}\Z$，其中$n = n_{11}n_{22}\cdots n_{kk}, \Z/n_{11}\Z$由$g_1$生成，$\Z/n_{22}\Z$由$g_2$生成等等。
也可以按素因子分解$n = p_1^{n_1}p_2^{n_2}\cdots$将$G \simeq \Z/n\Z$写成$\Z/p_1^{n_1}\Z\times\Z/p_2^{n_2}\Z\times\cdots$.
