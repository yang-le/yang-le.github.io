...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Get the high score form local storage or set it to 0 if not found
    ...
    // render the game board on the UI
    ...
    function placeRandom() {
        ...
        if (available.length > 0) {
            ...
            cell.classList.add('new-tile'); // Animation for new tile
        }
    }
    ...
    document.addEventListener('touchend', event => {
        const touch_end = event.changedTouches[0];
        const dx = touch_end.screenX - touch_start.screenX;
        const dy = touch_end.screenY - touch_start.screenY;
